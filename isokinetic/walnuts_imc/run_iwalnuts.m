...
% Isokinetic kinetic-energy level: 2 K0 = d - 1
K0 = (d - 1) / 2;
...
tic
for i = 1:n_samples
    % IMC–WALNUTS call: note the extra K0 argument
    [theta, T] = iwalnuts(@log_funnel_density, ...
                         @grad_log_funnel_density, ...
                         theta, h, i_max, delta, K0);
    res{i}   = theta;
    T_vec(i) = T;
end
toc
